...
namespace QuantityMeasurementApp.UI
{
    public class Menu
    {
        public void Show()
        {
            ...
            Console.WriteLine("8. Add Two Volumes");
            Console.WriteLine("9. Convert Volume");
            Console.WriteLine("10. Check Volume Equality");
            ...
            switch (choice)
            {
                ...
                case 8: AddVolumes(); break;
                case 9: ConvertVolume(); break;
                case 10: CheckVolumeEquality(); break;
                case 11: Console.WriteLine("Exiting..."); break;
        ...
        private void ConvertVolume()
        {
            ...
            Quantity<VolumeUnit> q = new Quantity<VolumeUnit>(value, source);

            Quantity<VolumeUnit> result = q.ConvertTo(target);
