    ...
    public class Menu
    {
        public void Show()
        {
            ...
            switch (choice)
            {
                ...
                case 19: Console.WriteLine("Exiting..."); break;
        ...
        {
            TemperatureUnit[] units = new TemperatureUnit[]
            {
        ...
        private void ConvertTemperature()
        {
            ...
            Quantity<TemperatureUnit> q = new Quantity<TemperatureUnit>(value, from);

            Quantity<TemperatureUnit> result = q.ConvertTo(to);

            Console.WriteLine("Result: " + result.GetValue() + " " + to);
        }
        ...
        private void CheckTemperatureEquality()
        {
            ...
            Quantity<TemperatureUnit> q1 = new Quantity<TemperatureUnit>(v1, u1);
            Quantity<TemperatureUnit> q2 = new Quantity<TemperatureUnit>(v2, u2);
